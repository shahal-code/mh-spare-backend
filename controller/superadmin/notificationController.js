...
export const getNotifications = async (req, res) => {
  try {
    const { getAdminNotifications } = await import('../../services/superadmin/notificationService.js');
...
export const markNotificationsRead = async (req, res) => {
  try {
    const { markNotificationsAsRead } = await import('../../services/superadmin/notificationService.js');
